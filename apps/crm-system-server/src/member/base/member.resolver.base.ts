...
export class MemberResolverBase {
  ...
  async createMember(@graphql.Args() args: CreateMemberArgs): Promise<Member> {
    return await this.service.createMember({
      ...
      data: {
        ...
        membershipType: args.data.membershipType
          ? {
              connect: args.data.membershipType,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => MembershipType, {
    nullable: true,
    name: "membershipType",
  })
  @nestAccessControl.UseRoles({
  ...
  async getMembershipType(
    ...
    const result = await this.service.getMembershipType(parent.id);
